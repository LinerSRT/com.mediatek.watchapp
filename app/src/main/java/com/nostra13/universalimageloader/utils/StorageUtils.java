...
public final class StorageUtils {
    ...
    public static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        C0197L.m4w("Can't define system cache directory! '%s' will be used.", "/data/data/" + context.getPackageName() + "/cache/");
        ...
        if (!appCacheDir.exists()) {
            if (appCacheDir.mkdirs()) {
                try {
                    ...
                    C0197L.m3i("Can't create \".nomedia\" file in application external cache directory", new Object[0]);
                }
            } else {
                C0197L.m4w("Unable to create external cache directory", new Object[0]);
                return null;
            }
        }
        return appCacheDir;
