...
public class NotificationHelper {
    ...
    public static void dumpNotification(Notification n) {
        ...
        bm = getPicture(localBundle);
        if (bm != null) {
            Log.d("NotificationHelper", "big picture: " + bm.getWidth() + "x" + bm.getHeight());
        }
        ...
        if (cs != null) {
            ...
            for (CharSequence charSequence : cs) {
                Log.d("NotificationHelper", "line: " + charSequence);
            }
        }
        ...
        if (count > 0) {
            for (i = 0; i < count; i++) {
                Log.d("NotificationHelper", "action " + i + ": " + getAction(n, i));
            }
        }
