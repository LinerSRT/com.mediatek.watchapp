...
public class MainVerticalViewPager extends ViewGroup {
    private static final Comparator<ItemInfo> COMPARATOR = new C01261();
    private static final int[] LAYOUT_ATTRS = new int[]{16842931};
    private static final Interpolator sInterpolator = new C01272();
    ...
    private final Runnable mEndScrollRunnable = new C01283();
    ...
    /* renamed from: com.mediatek.watchapp.MainVerticalViewPager$1 */
    static class C01261 implements Comparator<ItemInfo> {
        C01261() {
        }
    ...
    /* renamed from: com.mediatek.watchapp.MainVerticalViewPager$2 */
    static class C01272 implements Interpolator {
        C01272() {
        }
    ...
    /* renamed from: com.mediatek.watchapp.MainVerticalViewPager$3 */
    class C01283 implements Runnable {
        C01283() {
        }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (event.getEventType() == 4096 && MainVerticalViewPager.this.mAdapter != null) {
    ...
    private boolean performDrag(float y) {
        ...
        if (scrollY < topBound) {
            if (topAbsolute) {
                z = this.mTopEdge.onPull(Math.abs(topBound - scrollY) / ((float) height));
            }
            scrollY = topBound;
        } else if (scrollY > bottomBound) {
            if (bottomAbsolute) {
                z = this.mBottomEdge.onPull(Math.abs(scrollY - bottomBound) / ((float) height));
            }
            scrollY = bottomBound;
        }
    ...
    public boolean arrowScroll(int direction) {
        ...
        if (currentFocused == this) {
            ...
            for (MainVerticalViewPager parent = currentFocused.getParent(); parent instanceof ViewGroup; parent = parent.getParent()) {
                if (parent == this) {
                    isChild = true;
                    break;
                }
