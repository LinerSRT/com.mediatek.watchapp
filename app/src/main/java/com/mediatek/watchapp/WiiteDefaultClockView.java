...
public class WiiteDefaultClockView extends View {
    ...
    /* renamed from: com.mediatek.watchapp.WiiteDefaultClockView$1 */
    class C01691 implements Runnable {
        ...
        public void run() {
            if (!WiiteDefaultClockView.this.mTickerStopped) {
                WiiteDefaultClockView.this.onTimeChange();
                WiiteDefaultClockView.this.invalidate();
                long now = SystemClock.uptimeMillis();
                WiiteDefaultClockView.this.mHandler.postAtTime(WiiteDefaultClockView.this.mTicker, now + (100 - (now % 100)));
            }
        }
    }
