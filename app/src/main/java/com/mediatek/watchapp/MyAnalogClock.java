...
public class MyAnalogClock extends View {
    ...
    private void drawMonth(Canvas canvas) {
        if (this.mChanged && this.mMonthPostion != null) {
            ...
            int dX = (this.SCREEN_WIDE * center.f2x) / 100;
            int dY = (this.SCREEN_WIDE * center.f3y) / 100;
            if (this.mMonthSize > 0) {
                ...
                canvas.drawText(this.mStrMonth, (float) pos.f2x, (float) pos.f3y, this.mPaint);
            }
    ...
    private void drawDate(Canvas canvas) {
        if (this.mChanged && this.mDatePostion != null) {
            ...
            if (this.mDateSize > 0) {
                ...
                canvas.drawText(this.mStrDate, (float) pos.f2x, (float) pos.f3y, this.mPaint);
            }
    ...
    private void drawWeek(Canvas canvas) {
        if (this.mChanged && this.mWeekPostion != null) {
            ...
            if (this.mWeekSize > 0) {
                ...
                canvas.drawText(this.mStrWeek, (float) pos.f2x, (float) pos.f3y, this.mPaint);
            }
    ...
    private void drawBattery(Canvas canvas) {
        if (this.mChanged && this.mBatteryLevel >= 0 && this.mBatteryPostion != null) {
            ...
            if (this.mBatterySize > 0) {
                ...
                canvas.drawText(this.mStrBattery, (float) pos.f2x, (float) pos.f3y, this.mPaint);
            }
    ...
    private void drawStep(Canvas canvas) {
        ...
        if (this.mChanged && this.mStepPostion != null) {
            ...
            if (this.mStepSize > 0) {
                ...
                canvas.drawText(this.mStrStep, (float) pos.f2x, (float) pos.f3y, this.mPaint);
            }
    ...
    private Postion getLeftTopPostion(Paint paint, Postion pos, String str) {
        ...
        return new Postion(((this.SCREEN_WIDE * pos.f2x) / 100) - (this.mRect.width() / 2), ((this.SCREEN_WIDE * pos.f3y) / 100) + (this.mRect.height() / 2));
    }
