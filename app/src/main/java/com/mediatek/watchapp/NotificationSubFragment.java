...
import com.mediatek.watchapp.NotificationScrollView.Callback;
...
public class NotificationSubFragment extends Fragment implements Callback {
    ...
    /* renamed from: com.mediatek.watchapp.NotificationSubFragment$1 */
    ...
    /* renamed from: com.mediatek.watchapp.NotificationSubFragment$2 */
    ...
    public static NotificationSubFragment create(StatusBarNotification mSbn) {
        NotificationSubFragment fragment = new NotificationSubFragment();
        fragment.setContent(mSbn);
        return fragment;
    }

    public void setContent(StatusBarNotification mSbn) {
        this.mSbn = mSbn;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mOptions.setOnClickListener(new C01421());
        this.mDismiss.setOnClickListener(new C01432());
        if (this.mSbn == null) {
    ...
    public void handleSwipe(View view) {
        if (this.mContext != null) {
            this.mContext.sendBroadcast(new Intent("com.mediatek.watchapp.NOTIFICATION_LISTENER.CANCEL").putExtra("key", this.mKey));
        }
        try {
    ...
    private void loadAndSetActions(Notification mNotification) {
        WearableExtender mExtender = new WearableExtender(mNotification);
    ...
    public void refreshContent() {
        ...
        if (this.mRootView != null && this.mSbn != null) {
            ...
            if (pkg.equals("com.mediatek.wearable") || pkg.equals("com.weitetech.smartconnect.wiiwearsdk") || pkg.equals("com.weite.smartconnect.wiiwearsdk")) {
                isFromPhone = true;
            }
            if (isFromPhone) {
