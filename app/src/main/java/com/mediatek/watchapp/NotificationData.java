...
public class NotificationData {
    ...
    private final Comparator<Entry> mEntryCmp = new C01321();
    private final Comparator<Entry> mEntryPostTimeCmp = new C01332();

    /* renamed from: com.mediatek.watchapp.NotificationData$1 */
    class C01321 implements Comparator<Entry> {
        C01321() {
        }
    ...
    /* renamed from: com.mediatek.watchapp.NotificationData$2 */
    class C01332 implements Comparator<Entry> {
        C01332() {
        }
    ...
    public Entry findByKey(String pkgName, String tag, int id) {
        for (Entry e : this.mEntries) {
            if (!(tag == null && e.notification.getTag() == null)) {
                if (tag != null && tag.equals(e.notification.getTag())) {
                }
            }
            if (pkgName.equals(e.notification.getPackageName()) && id == e.notification.getId()) {
                return e;
            }
        }
        return null;
