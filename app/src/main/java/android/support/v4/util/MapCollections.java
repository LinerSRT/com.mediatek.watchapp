...
abstract class MapCollections<K, V> {
    ...
    final class EntrySet implements Set<Entry<K, V>> {
        ...
        public boolean addAll(Collection<? extends Entry<K, V>> collection) {
            ...
            if (oldSize == MapCollections.this.colGetSize()) {
                return false;
            }
            return true;
        }
    ...
    final class MapIterator implements Iterator<Entry<K, V>>, Entry<K, V> {
        ...
        public final boolean equals(Object o) {
            ...
            if (!this.mEntryValid) {
                ...
                Entry<?, ?> e = (Entry) o;
                if (ContainerHelpers.equal(e.getKey(), MapCollections.this.colGetEntry(this.mIndex, 0))) {
                    if (!ContainerHelpers.equal(e.getValue(), MapCollections.this.colGetEntry(this.mIndex, 1))) {
                    }
                    return z;
                }
                z = false;
