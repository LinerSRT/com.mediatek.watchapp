...
public class ViewCompat {
    ...
    static class BaseViewCompatImpl implements ViewCompatImpl {
        ...
        public boolean canScrollHorizontally(View v, int direction) {
            if ((v instanceof ScrollingView) && canScrollingViewScrollHorizontally((ScrollingView) v, direction)) {
                return true;
            }
            return false;
        }
        ...
        public boolean canScrollVertically(View v, int direction) {
            if ((v instanceof ScrollingView) && canScrollingViewScrollVertically((ScrollingView) v, direction)) {
                return true;
            }
            return false;
        }
