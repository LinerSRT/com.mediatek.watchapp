...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C00022 extends FragmentContainer {
        C00022() {
        }
    ...
    public Object getReturnTransition() {
        ...
        if (this.mAnimationInfo.mReturnTransition != USE_DEFAULT_TRANSITION) {
            access$100 = this.mAnimationInfo.mReturnTransition;
        } else {
            access$100 = getEnterTransition();
        }
        return access$100;
    }
    ...
    public Object getReenterTransition() {
        ...
        if (this.mAnimationInfo.mReenterTransition != USE_DEFAULT_TRANSITION) {
            access$300 = this.mAnimationInfo.mReenterTransition;
        } else {
            access$300 = getExitTransition();
        }
        return access$300;
    }
    ...
    public Object getSharedElementReturnTransition() {
        ...
        if (this.mAnimationInfo.mSharedElementReturnTransition != USE_DEFAULT_TRANSITION) {
            access$500 = this.mAnimationInfo.mSharedElementReturnTransition;
        } else {
            access$500 = getSharedElementEnterTransition();
        }
        return access$500;
    }
    ...
    public void startPostponedEnterTransition() {
        if (this.mFragmentManager == null || this.mFragmentManager.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C00011());
        }
    }
    ...
    void instantiateChildFragmentManager() {
        if (this.mHost != null) {
            ...
            this.mChildFragmentManager.attachController(this.mHost, new C00022(), this);
            return;
        }
    ...
    int getNextAnim() {
        return this.mAnimationInfo != null ? this.mAnimationInfo.mNextAnim : 0;
    }
    ...
    int getNextTransition() {
        return this.mAnimationInfo != null ? this.mAnimationInfo.mNextTransition : 0;
    }
    ...
    int getNextTransitionStyle() {
        return this.mAnimationInfo != null ? this.mAnimationInfo.mNextTransitionStyle : 0;
    }
    ...
    int getStateAfterAnimating() {
        return this.mAnimationInfo != null ? this.mAnimationInfo.mStateAfterAnimating : 0;
    }
