...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C00671();
        ...
        private final Callback mVerticalBoundCheckCallback = new C00682();
        private int mWidth;
        ...
        class C00682 implements Callback {
            C00682() {
            }
        ...
        private int[] getChildRectangleOnScreenScrollAmount(RecyclerView parent, View child, Rect rect, boolean immediate) {
            ...
            if (getLayoutDirection() == 1) {
                dx = offScreenRight == 0 ? Math.max(offScreenLeft, childRight - parentRight) : offScreenRight;
    ...
    public final class Recycler {
        ...
        void updateViewCacheSize() {
            ...
            if (RecyclerView.this.mLayout != null) {
                extraCache = RecyclerView.this.mLayout.mPrefetchMaxCountObserved;
            }
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            if (position >= 0 && position < RecyclerView.this.mState.getItemCount()) {
                ...
                android.view.ViewGroup.LayoutParams rvLayoutParams2;
                if (lp == null) {
                    rvLayoutParams2 = (LayoutParams) RecyclerView.this.generateDefaultLayoutParams();
                    holder.itemView.setLayoutParams(rvLayoutParams2);
                } else if (RecyclerView.this.checkLayoutParams(lp)) {
                    rvLayoutParams = (LayoutParams) lp;
                } else {
                    rvLayoutParams2 = (LayoutParams) RecyclerView.this.generateLayoutParams(lp);
                    holder.itemView.setLayoutParams(rvLayoutParams2);
                }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C00691());
        Parcelable mLayoutState;

        /* renamed from: android.support.v7.widget.RecyclerView$SavedState$1 */
        static class C00691 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00691() {
            }
        ...
        public void run() {
            if (RecyclerView.this.mLayout != null) {
                ...
                if (scroller.computeScrollOffset()) {
                    ...
                    if (dx != 0 || dy != 0) {
                        if (!(fullyConsumedHorizontal || fullyConsumedVertical)) {
    ...
    public static abstract class ViewHolder {
        ...
        public final int getAdapterPosition() {
            return this.mOwnerRecyclerView != null ? this.mOwnerRecyclerView.getAdapterPositionFor(this) : -1;
        }
    ...
    private boolean isPreferredNextFocus(View focused, View next, int direction) {
        ...
        if (isPreferredNextFocusAbsolute(focused, next, (i ^ rtl) == 0 ? 17 : 66)) {
            return true;
        }
        if (direction != 2) {
    ...
    private boolean isPreferredNextFocusAbsolute(android.view.View r6, android.view.View r7, int r8) {
        /*
        r5 = this;
        r0 = 1;
        r1 = 0;
    ...
    L_0x0029:
        ...
        r1.<init>();
        r2 = "direction must be absolute. received:";
        r1 = r1.append(r2);
        r1 = r1.append(r8);
        r1 = r1.toString();
        r0.<init>(r1);
    ...
    L_0x00c6:
        goto L_0x00ba;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v7.widget.RecyclerView.isPreferredNextFocusAbsolute(android.view.View, android.view.View, int):boolean");
    }
    ...
    private void processAdapterUpdatesAndSetAnimationFlags() {
        ...
        if (this.mFirstLayoutComplete && this.mItemAnimator != null) {
            if (this.mDataSetHasChangedAfterLayout || animationTypeSupported || this.mLayout.mRequestedSimpleAnimations) {
        ...
        if (this.mPreserveFocusAfterLayout && this.mAdapter != null && hasFocus() && getDescendantFocusability() != 393216) {
            ...
            if (!isFocused()) {
                ...
                if (IGNORE_DETACHED_FOCUSED_CHILD) {
                    if (focusedChild.getParent() == null || !focusedChild.hasFocus()) {
    ...
    public void draw(Canvas c) {
        ...
        if (!(this.mLeftGlow == null || this.mLeftGlow.isFinished())) {
            ...
            needsInvalidate = (this.mLeftGlow != null && this.mLeftGlow.draw(c)) ? 1 : 0;
        ...
        if (!(this.mTopGlow == null || this.mTopGlow.isFinished())) {
            ...
            int i3 = (this.mTopGlow != null && this.mTopGlow.draw(c)) ? 1 : 0;
            needsInvalidate |= i3;
            c.restoreToCount(restore);
        }
        if (!(this.mRightGlow == null || this.mRightGlow.isFinished())) {
            ...
            i3 = (this.mRightGlow != null && this.mRightGlow.draw(c)) ? 1 : 0;
            needsInvalidate |= i3;
            c.restoreToCount(restore);
        }
    ...
    Rect getItemDecorInsetsForChild(View child) {
        ...
        if (this.mState.isPreLayout()) {
            if (lp.isItemChanged() || lp.isViewInvalid()) {
                return lp.mDecorInsets;
            }
        }
        Rect insets = lp.mDecorInsets;
